            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card h-100 py-5 text-center shadow-sm">
                        <div class="card-body">
                            <i
                                class="fas fa-envelope fa-2x text-primary mb-3"
                            ></i>
                            <h5 class="card-title">Email</h5>
                            <p class="card-text">
                                anggapajaemailresmi@gmail.com
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    >
                        <div class="card h-100 py-5 text-center shadow-sm">
                            <div class="card-body">
                                <i
                                    class="fas fa-comments fa-2x text-primary mb-3"
                                ></i>
                                <h5 class="card-title">Whatsapp Kami</h5>
                                <p>Chat dengan tim kami</p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            >
                                <a
                                    href="https://github.com/nadilabrn/"
                                    target="#_blank"
                                    class="link-github"
                                >
                                    <img
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            >
                                <a
                                    href="https://github.com/UswatunQasanah/"
                                    target="#_blank"
                                    class="link-github"
                                >
                                    <img
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            ...
                            >
                                <a
                                    href="https://github.com/muammarnibros/"
                                    target="#_blank"
                                    class="link-github"
                                >
                                    <img
        ...
        return {
            ...
            faqs: [
                ...
                },
                {
                    ...
                    answer: "Ya, Anda bisa upload foto sebagai bukti saat membuat pengaduan.",
                },
                {
                    question:
                        "Bisakah mengubah data pengaduan yang sudah dikirim?",
                    answer: "Tidak bisa, namun Anda dapat membuat pengaduan baru dengan data yang benar.",
                },
                {
                    question: "Apakah data saya aman?",
                    answer: "Ya, data Anda kami simpan dan kelola sesuai ketentuan privasi.",
                },
                {
                    question: "Siapa yang menangani pengaduan saya?",
                    answer: "Pengaduan Anda akan ditindaklanjuti oleh petugas terkait dari instansi tujuan.",
                },
                {
                    question: "Apakah saya akan mendapatkan notifikasi aduan",
                    answer: "Ya, notifikasi akan dikirim lewat aplikasi telegram via chat.",
                },
                {
                    question:
                        "Apa saja jenis pengaduan yang bisa saya kirimkan?",
                    answer: "Jenis aduan dapat dilihat di kategori saat anda membuat aduan.",
                },
            ],
        };
    },
